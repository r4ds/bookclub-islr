...
Script source: https://emilhvitfeldt.github.io/ISLR-tidymodels-labs/tree-based-methods.html

## Decision Tree Terminology

![Source: https://medium.com/@scid2230/decision-tree-basics-34d864483c42](images/decision_tree_structure.png)

## Decision Trees Explained (StatQuest)
...
```{r, plot_final_fit_tree_class__diagram}
class_tree_final_fit %>%
  extract_fit_engine() %>%
  rpart.plot(roundint = FALSE)
```
...
Training RMSE: __0.657__
Testing RMSE: __1.34 (overfit)__
...
Training RMSE: __0.860__
Testing RMSE: __1.35 (still overfitting)__
