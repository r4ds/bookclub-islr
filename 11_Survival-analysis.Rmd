...
> Note that this construction is similar to that of the Kaplan-Meier curve, if $-\ln (\frac{r_j- q_j}{r_j}) \approx q_j/r_j$ is the integrated hazard during the time between deaths.
...
* For a censored data point, the factor is just $S(y_i)$, the likelihood of surviving at *least* until $y_i$.
