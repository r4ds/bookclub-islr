...
<span style="color: yellow;">Yellow</span>: Training set MSE
...
<span style="color: yellow;">Yellow</span>: As models become more flexible and complex, the training error is reduced, but with diminishing benefit.
...
>>This dataset was obtained from, and is slightly modified from, the Boston dataset that is part of the
MASS library. References are available in the MASS library.
